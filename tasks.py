...
llm = ChatOpenAI(model="gpt-4o", base_url="https://llmgateway-litellm.lshc-dev02-prodvpc-use1.lshcai.deloitteinnovation.us",)
...
embeddings_model = OpenAIEmbeddings(
        model="text-embedding-3-large",
        base_url="https://llmgateway-litellm.lshc-dev02-prodvpc-use1.lshcai.deloitteinnovation.us",
        dimensions=1536
)
